...
func _ready() -> void:
	...
	lip_filler.change_data(0, 0, "#LipFiller", "Get big, luscious lips 💋", "-$700", lip_img,  0, 700)
	boob_job.change_data(1, 0, "#BoobJob", "Upgrade your look... twice 👀", "-$6000", boob_img, 0, 6000)
	hair.change_data(2, 0, "#SilkyHair", "Get rid of the frizz 👱‍♀️", "-$20", hair_img, 0, 20)
	makeup.change_data(3, 0, "#LashExtensions", "Get voluminous lashes 👁️", "-$100", makeup_img, 0, 100)
...
func _on_upgrade_pressed(idx, idy, follower_price, money_price) -> void:
	to_sponzorusa.emit(idx, idy)
	$"../../../../..".money -= money_price
	$"../../../../..".followers -= follower_price
	
	match idx:
		0: #lips
			match idy:
				0:
					lip_filler.change_data(0, 1, "#LipFiller", "Make em kissable 😘", "-$1400", lip_img,  0, 1400)
				1:
					lip_filler.change_data(0, 2, "#LipFiller", "Make em JUICY 💋", "-$2100", lip_img,  0, 2100)
		1: #boobs
			match idy:
				0:
					boob_job.change_data(1, 1, "#BoobJob", "Get them melons 🍈", "-$12000", boob_img, 0, 12000)
				1:
					boob_job.change_data(1, 2, "#BoobJob", "Give em gravity 🌍", "-$18000", boob_img, 0, 18000)
		2: #hair
			match idy:
				0:
					hair.change_data(2, 1, "#BlondeHair", "Brighten up your look ☀️", "-$100", hair_img, 0, 100)
				1:
					hair.change_data(2, 2, "#Extensions", "Just like Rapunzel 👱‍♀️", "-$500", hair_img, 0, 500)
		3: #makeup
			match idy:
				0:
					makeup.change_data(3, 1, "#JimmyMUA", "See a famous MUA", "-$500", makeup_img, 0, 500)
				1: 
					makeup.change_data(3, 2, "#TattooMakeup", "Be beautiful, always", "-$1000", makeup_img, 0, 1000)
